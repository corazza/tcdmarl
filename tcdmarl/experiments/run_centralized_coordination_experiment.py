...
def run_qlearning_task(
    ...
    for t in range(num_steps):
        ...
        if (
            ...
            # USER: it does not seem to be the case that the Q-function will be updated during testing, because we use update_q_function=False in the testing function
