...
from tcdmarl.Environments.button.multi_agent_buttons_env import MultiAgentButtonsEnv
...
def create_centralized_environment(
    ...
    elif tester.experiment == "centralized_buttons" or tester.experiment == "buttons":
