    ...
    for t in range(num_steps):
        ...
        if (
            ...
            for i in range(num_agents):
                ...
                agent_copy = iqAgent(
                    s_i, meta_state_i, num_states, num_meta_states, actions, agent_id
                )
            ...
            testing_reward, trajectory, testing_steps = run_iql_test(
                agent_list_copy,
                tester,
                learning_params,
                testing_params,
...
def run_iql_test(agent_list, tester, learning_params, testing_params, show_print=True):
    """
...
def run_iql_experiment(tester, num_agents, num_times, show_print=True):
    """
    ...
    for t in range(num_times):
        ...
        for i in range(num_agents):
            ...
            agent_list.append(
                iqAgent(s_i, meta_state_i, num_states, num_meta_states, actions, i)
            )
        ...
        while not tester.stop_learning():
            ...
            run_iql_training(epsilon, tester, agent_list, show_print=show_print)
