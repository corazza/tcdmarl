...
from tcdmarl.tcrl.custom_dfas_neurips import dfa_paper_buttons
...
def buttons_config(num_times: int, use_tlcd: bool) -> Tester:
    """
    ...
    total_steps = 20 * step_unit  # 100 * step_unit
    min_steps = 1
