...
class ButtonsState:
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, ButtonsState):
            return False
        return (
            self.yellow_button_pushed == other.yellow_button_pushed
            and self.green_button_pushed == other.green_button_pushed
            and self.red_button_pushed == other.red_button_pushed
        )
