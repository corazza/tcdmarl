...
def dfa_paper_sync_next_sensors() -> CausalDFA:
    ...
    # Happpy
    builder.t(1, "a&!b&!c&!d&!e", 2)  # Transition to state 2 on 'a'
    builder.t(1, "!a&b&!c&!d&!e", 3)  # Transition to state 3 on 'b'

    # Unhappy
    builder.t(
        1, "(a&!b&!c&!d&!e|!a&b&!c&!d&!e)~", 4
    )  # Transition to sink state 4 on 'c'
